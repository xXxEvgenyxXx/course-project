  ...
  return (
    <div className="serverspage-wrapper">
      ...
      <div className="hero-section">
        <h1>Наши серверы</h1>
        <p>Мы создаем неповторимые серверы, дополняя их своими уникальными разработками. 
          Для каждой сборки мы отбираем интересные моды, делаем направления развития железных дорог и пишем квесты</p>
      </div>
      <SubServersCards />
      <Footer />
    </div>
